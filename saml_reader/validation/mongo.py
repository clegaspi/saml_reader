...
from saml_reader.validation.input_validation import (
    MongoFederationConfig,
    UserInputValidator,
)
...
class MongoSamlValidator:
    ...
    def _build_report(self, test_suite):
        ...
        failed_tests = [
            test
            for test in test_suite.get_list_of_mongo_tests()
        ...
        ).get_messages_by_name(failed_tests)

        # Write report messages in order, filtering out any tests with no messages
        self._errors = [messages[test] for test in failed_tests if messages[test]]
    ...
    def get_missing_claim_attributes(self):
        ...
        missing_required_attributes = MongoTestSuite.REQUIRED_CLAIMS - set(
            attribs.keys()
        )
...
class MongoTestSuite(TestSuite):
    ...
    REQUIRED_CLAIMS = {"firstName", "lastName"}
    ...
    def _get_tests():
        ...
        tests = [
            ...
            TestDefinition(
                "exists_name_id",
                MongoTestSuite.verify_name_id_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_name_id",
                MongoTestSuite.verify_name_id_pattern,
                dependencies=["exists_name_id"],
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_name_id_format",
                MongoTestSuite.verify_name_id_format_exists,
                dependencies=["exists_name_id"],
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_name_id_format",
                MongoTestSuite.verify_name_id_format,
                dependencies=["exists_name_id_format"],
                required_context=["saml"],
            ),
            # Claim attribute tests
            TestDefinition(
                "exists_all_required_attributes",
                MongoTestSuite.verify_all_required_attributes_exist,
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_first_name",
                MongoTestSuite.verify_first_name_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "not_multivalued_first_name",
                MongoTestSuite.verify_first_name_is_not_multivalued,
                dependencies=["exists_first_name"],
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_first_name",
                MongoTestSuite.verify_first_name_pattern,
                dependencies=["not_multivalued_first_name"],
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_last_name",
                MongoTestSuite.verify_last_name_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "not_multivalued_last_name",
                MongoTestSuite.verify_last_name_is_not_multivalued,
                dependencies=["exists_last_name"],
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_last_name",
                MongoTestSuite.verify_last_name_pattern,
                dependencies=["not_multivalued_last_name"],
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_member_of",
                MongoTestSuite.verify_member_of_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "member_of_not_empty",
                MongoTestSuite.verify_member_of_not_empty,
                dependencies=["exists_member_of"],
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_member_of",
                MongoTestSuite.verify_member_of_pattern,
                dependencies=["member_of_not_empty"],
                required_context=["saml"],
            ),
            TestDefinition(
                "not_duplicate_member_of",
                MongoTestSuite.verify_member_of_is_not_duplicated,
                dependencies=["exists_member_of"],
                required_context=["saml"],
            ),
            # Claim attribute comparison tests
            TestDefinition(
                "exists_comparison_first_name",
                MongoTestSuite.verify_first_name_comparison_exists,
                dependencies=["regex_first_name"],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "compare_first_name",
                MongoTestSuite.verify_first_name,
                dependencies=["exists_comparison_first_name"],
                required_context=["saml", "comparison_values"],
            ),
            TestDefinition(
                "exists_comparison_last_name",
                MongoTestSuite.verify_last_name_comparison_exists,
                dependencies=["regex_last_name"],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "compare_last_name",
                MongoTestSuite.verify_last_name,
                dependencies=["exists_comparison_last_name"],
                required_context=["saml", "comparison_values"],
            ),
            TestDefinition(
                "member_of_is_expected",
                MongoTestSuite.verify_member_of_is_expected,
                dependencies=[("exists_member_of", TEST_FAIL)],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "exists_comparison_member_of",
                MongoTestSuite.verify_member_of_comparison_exists,
                dependencies=["regex_member_of"],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "compare_member_of",
                MongoTestSuite.verify_member_of,
                dependencies=["exists_comparison_member_of"],
                required_context=["saml", "comparison_values"],
            ),
            # Email and Name ID comparison tests
            TestDefinition(
                "exists_comparison_email",
                MongoTestSuite.verify_email_comparison_exists,
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "compare_email_name_id",
                MongoTestSuite.verify_name_id,
                dependencies=["regex_name_id", "exists_comparison_email"],
                required_context=["saml", "comparison_values"],
            ),
            # Federated domain tests
            TestDefinition(
                "exists_comparison_domain",
                MongoTestSuite.verify_domain_comparison_exists,
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "compare_domain_comparison_email",
                MongoTestSuite.verify_domain_in_comparison_email,
                dependencies=["exists_comparison_email", "exists_comparison_domain"],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "compare_domain_name_id",
                MongoTestSuite.verify_domain_in_name_id,
            ...
            TestDefinition(
                "exists_issuer",
                MongoTestSuite.verify_issuer_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_issuer",
                MongoTestSuite.verify_issuer_pattern,
                dependencies=["exists_issuer"],
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_comparison_issuer",
                MongoTestSuite.verify_issuer_comparison_exists,
                dependencies=["regex_issuer"],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "match_issuer",
                MongoTestSuite.verify_issuer,
            ...
            TestDefinition(
                "exists_audience",
                MongoTestSuite.verify_audience_url_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_audience",
                MongoTestSuite.verify_audience_url_pattern,
                dependencies=["exists_audience"],
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_comparison_audience",
                MongoTestSuite.verify_audience_comparison_exists,
                dependencies=["regex_audience"],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "match_audience",
                MongoTestSuite.verify_audience_url,
            ...
            TestDefinition(
                "exists_acs",
                MongoTestSuite.verify_assertion_consumer_service_url_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_acs",
                MongoTestSuite.verify_assertion_consumer_service_url_pattern,
                dependencies=["exists_acs"],
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_comparison_acs",
            ...
            TestDefinition(
                "match_acs",
                MongoTestSuite.verify_assertion_consumer_service_url,
            ...
            TestDefinition(
                "exists_encryption",
                MongoTestSuite.verify_encryption_algorithm_exists,
                required_context=["saml"],
            ),
            TestDefinition(
                "regex_encryption",
                MongoTestSuite.verify_encryption_algorithm_pattern,
                dependencies=["exists_encryption"],
                required_context=["saml"],
            ),
            TestDefinition(
                "exists_comparison_encryption",
            ...
            TestDefinition(
                "match_encryption",
                MongoTestSuite.verify_encryption_algorithm,
            ...
            TestDefinition(
                "exists_certificate",
                MongoTestSuite.verify_certificate_exists,
                required_context=["certificate"],
            ),
            TestDefinition(
                "certificate_not_expired",
                MongoTestSuite.verify_certificate_not_expired,
                dependencies=["exists_certificate"],
                required_context=["certificate"],
            ),
            TestDefinition(
                "exists_comparison_cert_date",
                MongoTestSuite.verify_certificate_expiry_comparison_exists,
                dependencies=["certificate_not_expired"],
                required_context=["comparison_values"],
            ),
            TestDefinition(
                "match_certificate_expiry",
                MongoTestSuite.verify_certificate_expiry,
    ...
    def verify_issuer(context):
        ...
        """
        return context.get("saml").get_issuer_uri() == context.get(
            "comparison_values"
        ).get_parsed_value("issuer")
    ...
    def verify_issuer_pattern(context):
        ...
        return MongoTestSuite._matches_regex(
            UserInputValidator().get_validation_regex("issuer"),
    ...
    def verify_audience_url(context):
        ...
        Returns:
            (bool) True if they match, False otherwise
        """
        return context.get("saml").get_audience_url() == context.get(
            "comparison_values"
        ).get_parsed_value("audience")
    ...
    def verify_audience_url_pattern(context):
        ...
        """
        return MongoTestSuite._matches_regex(
            UserInputValidator().get_validation_regex("audience"),
    ...
    def verify_assertion_consumer_service_url(context):
        ...
        Returns:
            (bool) True if they match, False otherwise
        """
        return context.get("saml").get_assertion_consumer_service_url() == context.get(
            "comparison_values"
        ).get_parsed_value("acs")
    ...
    def verify_assertion_consumer_service_url_pattern(context):
        ...
        """
        return MongoTestSuite._matches_regex(
            UserInputValidator().get_validation_regex("acs"),
    ...
    def verify_encryption_algorithm_comparison_exists(context):
        ...
        """
        return (
            context.get("comparison_values").get_parsed_value("encryption") is not None
        )
    ...
    def verify_encryption_algorithm(context):
        ...
        return context.get("saml").get_encryption_algorithm() == context.get(
            "comparison_values"
        ).get_parsed_value("encryption")
    ...
    def verify_encryption_algorithm_pattern(context):
        ...
        """
        return MongoTestSuite._matches_regex(
            UserInputValidator().get_validation_regex("encryption"),
    ...
    def verify_name_id(context):
        ...
        """
        return (
            context.get("saml").get_subject_name_id().lower()
    ...
    def verify_name_id_format(context):
        ...
        """
        return (
            context.get("saml").get_subject_name_id_format()
            in MongoTestSuite.VALID_NAME_ID_FORMATS
        )
    ...
    def verify_all_required_attributes_exist(context):
        ...
        return all(
            attribute_name in saml_attributes
    ...
    @staticmethod
    def verify_first_name_is_not_multivalued(context):
        """
        Check if SAML response 'firstName' claims attribute is not multi-valued

        Returns:
            (bool) true if attribute is not multi-valued, false otherwise
        """
        return not isinstance(
            context.get("saml").get_attributes().get("firstName"), list
        )
    ...
    def verify_first_name_comparison_exists(context):
        ...
        """
        return (
            context.get("comparison_values").get_parsed_value("firstName") is not None
        )
    ...
    def verify_first_name(context):
        ...
        """
        return (
            context.get("comparison_values").get_parsed_value("firstName").lower()
    ...
    @staticmethod
    def verify_last_name_is_not_multivalued(context):
        """
        Check if SAML response 'lastName' claims attribute is not multi-valued

        Returns:
            (bool) true if attribute is not multi-valued, false otherwise
        """
        return not isinstance(
            context.get("saml").get_attributes().get("lastName"), list
        )
    ...
    def verify_last_name(context):
        ...
        """
        return (
            context.get("comparison_values").get_parsed_value("lastName").lower()
    ...
    def verify_member_of_is_expected(context):
        ...
        """
        return not context.get("comparison_values").get_parsed_value(
            "role_mapping_expected", False
        )
    ...
    def verify_member_of(context):
        ...
        return all(
            ...
            for group in context.get("comparison_values").get_parsed_value(
                "memberOf", []
            )
        )
    ...
    def verify_domain_in_name_id(context):
        ...
        """
        return any(
            context.get("saml").get_subject_name_id().lower().endswith("@" + domain)
    ...
    def verify_domain_in_comparison_email(context):
        ...
        """
        return any(
            context.get("comparison_values")
            .get_parsed_value("email")
            .lower()
            .endswith("@" + domain)
            for domain in context.get("comparison_values").get_parsed_value("domains")
        )
    ...
    def verify_certificate_expiry_comparison_exists(context):
        ...
        """
        return (
            context.get("comparison_values").get_parsed_value("cert_expiration")
            is not None
        )
...
class ValidationReport:
    ...
    def _get_claim_attribute_exist(attribute_name):
        return (
            f"The required '{attribute_name}' claim attribute is missing "
            + "or is misspelled (case matters!)"
        )

    @staticmethod
    def _get_claim_attribute_is_multivalued(attribute_name):
        return (
            f"The required '{attribute_name}' claim attribute has multiple values "
            + "when it should have only one."
        )

    def _get_claim_attribute_regex(self, attribute_name):
        return (
            f"The required '{attribute_name}' claim attribute does not "
    ...
    def _get_claim_attribute_mismatch(self, attribute_name):
        return (
            f"The required '{attribute_name}' claim attribute does not match "
    ...
    def _compile_messages(self):
        ...
        messages = {
            # Name ID tests
            "exists_name_id": f"The Name ID is missing from the SAML Subject.\n"
            ...
            "regex_name_id": f"The Name ID does not appear to be an email address.\n"
            f"Name ID: {self._saml.get_subject_name_id()}",
            "compare_email_name_id": "The Name ID does not match the provided email value:\n"
            ...
            "exists_name_id_format": "The Name ID format could not be parsed from the SAML response.",
            "regex_name_id_format": f"The Name ID format is not an acceptable format.\n"
            ...
            "not_multivalued_first_name": self._get_claim_attribute_is_multivalued(
                "firstName"
            ),
            ...
            "not_multivalued_last_name": self._get_claim_attribute_is_multivalued(
                "lastName"
            ),
            "regex_last_name": self._get_claim_attribute_regex("lastName"),
            "compare_last_name": self._get_claim_attribute_mismatch("lastName"),
            # Role mapping tests
            "member_of_is_expected": "The customer expects to use role mapping, but the 'memberOf' attribute\n"
            ...
            "compare_member_of": f"The optional 'memberOf' claim attribute is missing one or more values entered for comparison."
            + f"\nSAML value:"
            + self._print_a_list(
            ...
            "not_duplicate_member_of": "The 'memberOf' claim attribute is duplicated in the SAML response instead of being\n"
            ...
            # Federated domain tests
            "compare_domain_comparison_email": "The specified comparison email value does not contain\n"
            ...
            "compare_domain_name_id": "The Name ID does not contain one of the federated domains specified:\n"
            + f"Name ID value: {self._saml.get_subject_name_id()}\n"
            + f"Specified valid domains:"
            + self._print_a_list(
                "\n - {}", self._comparison_values.get_parsed_value("domains", [])
            ...
            # Issuer URI tests
            "exists_issuer": "The Issuer URI could not be parsed from the SAML response."
            + "\nCannot run any verification tests for this parameter.",
            "regex_issuer": f"The Issuer URI does not match the anticipated pattern.\n"
            + f"Issuer URI: {self._saml.get_issuer_uri()}",
            "match_issuer": "The Issuer URI in the SAML response does not match the specified comparison value:\n"
            ...
            # Audience URL tests
            "exists_audience": "The Audience URL could not be parsed from the SAML response."
            + "\nCannot run any verification tests for this parameter.",
            "regex_audience": f"The Audience URL does not match the anticipated pattern.\n"
            + f"Audience URL: {self._saml.get_audience_url()}",
            "match_audience": "The Audience URL in the SAML response does not match the specified comparison value:\n"
            + f"SAML value: {self._saml.get_audience_url()}\n"
            + f"Specified comparison value: {self._comparison_values.get_parsed_value('audience')}"
            + "\n\nGenerally, this means that the Atlas configuration needs "
            + "to be set to match the SAML value",
            # ACS URL tests
            "exists_acs": "The Assertion Consumer Service URL could not be parsed from the SAML response."
            + "\nCannot run any verification tests for this parameter.",
            "regex_acs": f"The Assertion Consumer Service URL does not match the anticipated pattern.\n"
            + f"ACS URL: {self._saml.get_assertion_consumer_service_url()}",
            "match_acs": "The Assertion Consumer Service URL in the SAML response does not match the "
            + "specified comparison value:\n"
            ...
            # Encryption algorithm tests
            "exists_encryption": "The encryption algorithm could not be parsed from the SAML response."
            + "\nCannot run any verification tests for this parameter.",
            "regex_encryption": f"The encryption algorithm does not match the anticipated pattern.\n"
            + f"Encryption Algorithm: {self._saml.get_encryption_algorithm()}",
            "match_encryption": "The encryption algorithm for the SAML response does not "
        ...
        if self._certificate is not None:
            messages.update(
                {
                    # Certificate tests
                    "certificate_not_expired": f"The SAML signing certificate included with the SAML response appears expired\n"
                    ...
                    "match_certificate_expiry": f"The expiration of the SAML signing certificate included with the SAML response\n"
