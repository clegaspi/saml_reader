...
def build_layout():
    ...
    comparison_fields = html.Div(
        [
            ...
            html.Br(),
            html.Label("SAML Certificate Expiration Date (MM/DD/YYYY)"),
            html.Br(),
            ...
            html.Div(
                id="div-domain-list",
                children=[
                    dcc.Markdown("List of domains:", style={"font-weight": "bold"}),
                    dcc.Checklist(
                        id="compare-domain-list",
                        options=[],
                        value=[],
                        inputStyle={"margin-right": "1em"},
                        labelStyle={"font-weight": "normal", "display": "block"},
                    ),
                ],
                style={
                    "width": "400px",
            ...
            dcc.Checklist(
                ...
                options=[{"label": "Role mapping expected?", "value": "Yes"}],
                inputStyle={"margin-right": "1em"},
            ),
            html.Div(
                ...
                hidden=True,
                children=[
                    html.Label("Expected Group Names"),
                    html.Br(),
                    dcc.Input(
    ...
    layout = html.Div(
        [left_side, right_side], className="row", style={"margin-bottom": "3em"}
    )
    return layout
